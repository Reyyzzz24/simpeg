...
class PayrollAdjustmentController extends Controller
{
    ...
    public function bulkStore(Request $request)
    {
        $validated = $request->validate([
            ...
            'items.*.formula_type' => 'nullable|in:hadir,jam_kerja,lembur,jam_mengajar_teori,jam_mengajar_praktik,jam_mengajar_normatif_teori,jam_mengajar_produktif_teori,jam_mengajar_produktif_praktik,jam_mengajar_eskul,piket',
