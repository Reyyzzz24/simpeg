...
class SalaryRuleController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'components.*.formula_type' => 'nullable|in:hadir,jam_kerja,lembur,jam_mengajar_teori,jam_mengajar_praktik,jam_mengajar_normatif_teori,jam_mengajar_produktif_teori,jam_mengajar_produktif_praktik,jam_mengajar_eskul,kehadiran_eskul,piket',
        ...
        foreach ($validated['components'] as $componentData) {
            ...
            SalaryRuleComponent::updateOrCreate(
                ...
                [
                    ...
                    'formula_type' => $componentData['formula_type'] ?? 'hadir',
