...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // SQLite / other drivers: enum stored as string, no schema change needed.
    }
    ...
    public function down(): void
    {
        ...
        DB::statement(
            "ALTER TABLE salary_rule_components MODIFY COLUMN formula_type ENUM('hadir', 'jam_kerja') NOT NULL DEFAULT 'hadir'"
        );

        if (Schema::hasTable('payroll_adjustments')) {
            DB::statement(
                "ALTER TABLE payroll_adjustments MODIFY COLUMN formula_type ENUM('hadir', 'jam_kerja') NOT NULL DEFAULT 'hadir'"
            );
        }
    }
};
