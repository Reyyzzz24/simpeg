...
{
    private string $expandedEnum = "ENUM('hadir', 'jam_kerja', 'lembur', 'jam_mengajar_teori', 'jam_mengajar_praktik', 'jam_mengajar_normatif_teori', 'jam_mengajar_produktif_teori', 'jam_mengajar_produktif_praktik', 'jam_mengajar_eskul', 'piket') NOT NULL DEFAULT 'hadir'";

    private string $previousEnum = "ENUM('hadir', 'jam_kerja', 'lembur', 'jam_mengajar_teori', 'jam_mengajar_praktik', 'jam_mengajar_normatif_teori', 'jam_mengajar_produktif_teori', 'jam_mengajar_produktif_praktik', 'piket') NOT NULL DEFAULT 'hadir'";
    ...
    public function down(): void
    {
        ...
        if (Schema::hasTable('salary_rule_components')) {
            DB::table('salary_rule_components')
                ->where('formula_type', 'jam_mengajar_eskul')
